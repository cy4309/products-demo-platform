...
const BaseLayout: React.FC<{ children: React.ReactNode }> = ({ children }) => {
  ...
  return (
    <div className="w-full min-h-[100dvh] flex flex-col bg-primary text-white">
      <header className="z-10 p-8 pb-12 w-full shadow flex justify-between items-center border-b fixed top-0 bg-primary">
      ...
      <footer className="z-10 p-8 pt-12 text-sm w-full fixed bottom-0 border-t bg-primary">
        <p>
